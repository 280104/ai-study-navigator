  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-accent text-primary-foreground shadow-button hover:opacity-90 hover:translate-y-[-1px] rounded-full font-medium tracking-wide",
        heroOutline: "border-2 border-foreground/20 bg-transparent text-foreground hover:border-foreground/40 hover:bg-foreground/5 rounded-full font-medium tracking-wide",
      },
      size: {
        ...
        icon: "h-10 w-10",
        // Premium sizes
        heroLg: "h-14 px-8 text-base",
        heroMd: "h-12 px-6 text-sm",
      },
    },
    defaultVariants: {
      variant: "default",
