    ...
    if (university) {
      ...
      if (!existingTaskUniIds.has(universityId)) {
        ...
        },
        {
          ...
          description: 'Request LOR from your primary academic advisor or professor',
          category: 'lor',
          completed: false,
        },
        {
          ...
          description: 'Request LOR from a second professor or research supervisor',
          category: 'lor',
          completed: false,
        },
        {
          id: crypto.randomUUID(),
          universityId,
          title: 'Request Letter of Recommendation #3',
          description: 'Request LOR from employer, mentor, or third professor (if applicable)',
          category: 'lor',
          completed: false,
        },
        {
        ...
        },
        {
          ...
          description: 'Prepare a professional resume tailored for graduate school applications',
          category: 'documents',
          completed: false,
        },
        {
          ...
          description: 'Prepare bank statements, sponsorship letters, or scholarship documents',
          category: 'documents',
          completed: false,
        },
        {
          id: crypto.randomUUID(),
          universityId,
          title: 'Prepare Portfolio (if required)',
          description: 'Compile work samples, research papers, or creative portfolio',
          category: 'documents',
          completed: false,
        },
        {
